...
* `docs/visual-variants.md` : Variant group rules for exploring alternate versions of the same visual idea.
...
8. Optional variants follow `docs/visual-variants.md`.
9. The generated image is cached under `regenerated/visualexpression/`.
10. The output can receive a visual review note.
11. If the visual matters, write a compact visual memory note.
12. Discord posting remains opt-in and should be designed separately.
...
Visual variants should follow `docs/visual-variants.md`.
